...
<div class="d-flex mt-2 justify-content-center">
    <div class="col-8">
        <a href="/employee/create" class="btn btn-success m-2"> Add Employee</a>
        <a href="/download-data/{{$company->id}}" class="btn btn-primary"> Download Data</a>
        @if (session('success'))
        ...
        @foreach ($company->employee as $employee)
            <tr>
                ...
                <td class="">
                    ...
                    @csrf
                    @method('DELETE')
                    <input type="hidden" name="url" id="" value="{{Request::url()}}">
